...
import {
	loadMyFirstLetters,
	loadFirstLettersIReplied,
	changeLetterBoxPage,
	changeUnread,
} from "../../redux/actions/letter";
			...
			<div>
				...
				<div>
					...
					>
						...
						{/* <div class="note">
							{letter.replyNumber > 0
								? letter.replyNumber + " replied"
								: null}
							{letter.unread > 0
